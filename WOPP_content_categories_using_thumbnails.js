...
const games = [
   ...
   /* {
    ...
    {
        "staging_ID": "6800509709486002176",
        "prod_ID": "6800509709486002176",
        "modal_type": "game_template_fuzzyfelt",
        "game": "Olympics",
        "Themed": "Outdoors",
        "Location": "Outside",
   ...
   /*{
    ...
    {
        "staging_ID": "6830942937757786112",
        "prod_ID": "6830942937757786112",
        "modal_type": "video_nursery",
        "game": "ABC Song",
        "Themed": "School",
        "Location": "Movie_Theatre",
...
//Location -- replace this term with another term from the game categories to separate content by another grouping
...
function positionItem(item, game){
    ...
    if (themes[groupNum].xcount === 5) {
        themes[groupNum].ypos -= yoffset;
        themes[groupNum].ypos += 2000; //why plus a thousand?
